...
export const metadata: Metadata = {
  title: "VenuX Membership | 20% Off All Treatments",
  description: "Join VenuX Membership with a prepaid balance from AUD $1,000 and receive 20% off all VenuX treatments.",
};

export default function Membership() {
  return <main><Header />
    <PageHero kicker="VenuX Membership" title="Prepay from $1,000." italic="Enjoy 20% off treatments." intro="A simple prepaid membership designed for clients who want consistent care and better value across the full VenuX treatment menu." />

    <section className="membership membership-page">
      <div>
        <p className="kicker light">The membership offer</p>
        <h2>One balance.<br /><span className="title-accent">Every treatment, 20% off.</span></h2>
      ...
      <div className="member-copy">
        <p>Use your prepaid VenuX balance toward clinic treatments while receiving 20% off every treatment on the VenuX menu.</p>
        <ul>
          <li><span>✓</span> Start with a minimum AUD $1,000 prepaid balance</li>
          <li><span>✓</span> Receive 20% off all VenuX treatments</li>
    ...
    <section className="membership-steps">
      ...
      <article><span>03</span><h3>Save</h3><p>Receive 20% off every treatment and pay from your available member balance.</p></article>
    </section>
