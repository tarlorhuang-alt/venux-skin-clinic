...
const faqs = [
  ...
  ["What does member price mean?", "VenuX Membership starts with a prepaid balance from AUD $1,000. DMK and Rejuran member prices are 15% off regular price; most other eligible treatments are 20% off."],
] as const;
