...
export function BookingForm() {
  ...
  return (
    <form onSubmit={submitBooking}>
      ...
      <label className="full booking-policy-check"><input required name="deposit-policy" type="checkbox" /><span>I understand the AUD $45 deposit is fully credited toward my booked treatment unless my existing Premium membership or active package makes this booking deposit-exempt. I may reschedule without losing a paid deposit when I give at least 24 hours’ notice.</span></label>
      ...
      {submitted && <p className="success full" role="status">Thank you. Your request {reference} is now in the VenuX booking system. Your selected time is not confirmed until the clinic contacts you. The team will confirm whether the AUD $45 deposit applies or is waived for your Premium membership or package.</p>}
    </form>
  );
}
