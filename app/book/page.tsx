    ...
    <section className="booking booking-page">
      <div className="booking-intro"><p className="kicker">Book & pay</p><h2>Your next step,<br />made simple.</h2>
        ...
        <div className="contact-card paypal-card">
          ...
          <ul className="deposit-policy-list"><li>Premium membership and active package clients: no deposit required</li><li>For other clients, fully credited toward the booked treatment</li><li>Reschedule with at least 24 hours’ notice</li><li>Late changes and no-shows may forfeit the deposit</li></ul>
          <p className="deposit-note"><strong>Already Premium?</strong> Submit your booking details without paying here. The system will match your mobile number and waive the deposit.</p>
          <PayPalCheckout />
