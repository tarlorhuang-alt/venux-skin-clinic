...
export async function AdminShell({ active, children }: { active: string; children: React.ReactNode }) {
  ...
  const links = [["Dashboard","/admin",false],["Bookings","/admin/bookings",false],["+ New client","/admin/clients/new",false],["Clients","/admin/clients",false],["Membership balances","/admin/memberships",false],["Package sessions","/admin/client-packages",false],["Package setup","/admin/packages",false],["Payroll","/admin/payroll",true],["Revenue & performance","/admin/reports",true],["Expenses","/admin/expenses",true],["Staff & time clock","/admin/staff",true],["Client retention","/admin/retention",false],["Messages","/admin/messages",false]] as const;
