...
export default async function ReportsPage({searchParams}:{searchParams:Promise<{from?:string;to?:string;error?:string}>}){
  ...
  return <AdminShell active="Revenue & performance"><header className="clinic-admin-head"><div><p>Financial & team reporting</p><h1>Revenue & performance</h1></div><span>Revenue and wage are recorded when a service starts</span></header>
